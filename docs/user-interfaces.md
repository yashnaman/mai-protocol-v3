...
```solidity
createPerpetual(address oracle, int256[10] calldata baseParams, int256[7] calldata riskParams, int256[7] calldata minRiskParamValues, int256[7] calldata maxRiskParamValues)
```
