...
contract Governor {
    ...
    function proposeCoreParameterUpdate(bytes32[] memory keys, int256[] memory values) public {
        ...
        _propose("updatePerpetualParameter(bytes32,int256)", calldatas, "CoreParameterUpdate");
    }
    ...
    function proposeRiskParameterUpdate(
        ...
        _propose(
            "updatePerpetualRiskParameter(bytes32,int256,int256,int256)",
            calldatas,
    ...
    function _propose(
        ...
        require(calldatas.length <= proposalMaxOperations(), "too many actions");
    ...
    function execute(uint256 proposalId) public {
        require(state(proposalId) == ProposalState.Succeeded, "proposal failed");
    ...
    function state(uint256 proposalId) public view returns (ProposalState) {
        ...
        if (block.number <= proposal.startBlock) {
            ...
            block.number >= proposal.endBlock.add(executingDelay()).add(executingTimeout())
        ) {
