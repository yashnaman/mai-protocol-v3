...
contract BrokerRelayOffline is ReentrancyGuardUpgradeable {
    ...
    function batchTrade(
        ...
        for (uint256 i = 0; i < orderCount; i++) {
            ...
            require(gasReward <= balanceOf(order.trader), "insufficient fee");
            require(gasReward <= order.brokerFeeLimit * GWEI, "fee exceeds trade gas limit");
