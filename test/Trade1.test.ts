    ...
    describe('basic', async () => {
        ...
        beforeEach(async () => {
            ...
            await testTrade.createPerpetual(
                ...
                [toWei("0.1"), toWei("0.05"), toWei("0.0001"), toWei("0.0007"), toWei("0"), toWei("0.005"), toWei("1"), toWei("0"), toWei("1000"), 1, toWei("10")],
        ...
        describe("trade", async () => {
            ...
            beforeEach(async () => {
                ...
                await testTrade.createPerpetual(
                    oracle.address,
                    // imr         mmr            operatorfr      lpfr            rebate        penalty        keeper       insur
                    [toWei("0.1"), toWei("0.05"), toWei("0.0001"), toWei("0.0008"), toWei("0"), toWei("0.005"), toWei("2"), toWei("0.0001"), toWei("10000"), 1, toWei("1")],
