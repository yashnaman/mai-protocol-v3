...
describe('TradeModule1', () => {
    ...
    describe('basic', async () => {
        ...
        //     await expect(testTrade.getFees(0, user0.address, none, toWei("100"), true)).to.be.revertedWith("insufficient fee");
        //     await expect(testTrade.getFees(0, user0.address, user2.address, toWei("100"), true)).to.be.revertedWith("insufficient fee");
        // })
