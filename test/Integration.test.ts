...
describe("integration", () => {
    ...
    it("broker", async () => {
        ...
        const order = {
            ...
            liquidityPool: "0x0000000000000000000000000000000000000000", // liquidityPool
            marketIndex: 0,
    ...
    it("main", async () => {
        ...
        const order = {
            ...
            data: ethers.utils.solidityPack(["uint64", "uint32", "uint8", "uint8", "uint64"], [1616217568, 3, 0, 0, 123456]).padEnd(66, "0"),
            chainID: 31337,
        };
        ...
        // await perpUser1.brokerTrade(order, toWei("0.1"), signature);
