...
describe("PoolCreator", () => {
    ...
    it("main", async () => {
        ...
        const perpAddr = await creator.callStatic.createLiquidityPool(ctk.address, false, 998);

        await creator.createLiquidityPool(ctk.address, false, 998);
    ...
    it("implementations", async () => {
        ...
        const perpAddr1 = await creator.callStatic.createLiquidityPool(ctk.address, false, 998);
        await creator.createLiquidityPool(ctk.address, false, 998);
        const perpAddr2 = await creator.callStatic.createLiquidityPool(ctk.address, false, 999);
        await creator.createLiquidityPool(ctk.address, false, 999);
