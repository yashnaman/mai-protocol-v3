...
describe('LiquidityPool', () => {
    ...
    //     expect(await liquidityPool.getPoolCash()).to.equal(toWei("-10"));
    //     expect(await liquidityPool.getTotalCollateral(0)).to.equal(toWei("210"));
    //     expect(await liquidityPool.callStatic.isAMMMarginSafe(0)).to.be.true;
    //     expect(await liquidityPool.callStatic.isAMMMarginSafe(1)).to.be.true;
    ...
    //     expect(await liquidityPool.getPoolCash()).to.equal(toWei("-360"));
    //     expect(await liquidityPool.getTotalCollateral(0)).to.equal(toWei("560"));
    //     expect(await liquidityPool.callStatic.isAMMMarginSafe(0)).to.be.false;
    //     expect(await liquidityPool.callStatic.isAMMMarginSafe(1)).to.be.true;
    // })
    // })
    ...
    describe("2 liquidityPool group", async () => {
        ...
        //     await liquidityPool.donateInsuranceFund2(0, toWei("10"));
        //     expect(await liquidityPool.getDonatedInsuranceFund(0)).to.equal(toWei("10"));
        //     expect(await liquidityPool.getTotalCollateral(0)).to.equal(toWei("10"));

        //     await liquidityPool.donateInsuranceFund2(0, toWei("11"));
        ...
        //     await liquidityPool.depositBySig(0, user0.address, toWei("10"), toBytes32(""), "0x");
        ...
        //     await liquidityPool.withdrawBySig(0, user0.address, toWei("10"), toBytes32(""), "0x");
        //     var { cash, position } = await liquidityPool.getMarginAccount(0, user0.address);
        ...
        it("clear", async () => {
            ...
            await liquidityPool.connect(user2).depositBySig(0, user2.address, toWei("3"), toBytes32(""), "0x");
            await liquidityPool.connect(user3).depositBySig(0, user3.address, toWei("4"), toBytes32(""), "0x");
            ...
            await liquidityPool.connect(keeper).clearBySig(0, toBytes32(""), "0x");
            await liquidityPool.connect(keeper).clearBySig(0, toBytes32(""), "0x");
            await liquidityPool.connect(keeper).clearBySig(0, toBytes32(""), "0x");
            await liquidityPool.connect(keeper).clearBySig(0, toBytes32(""), "0x");
